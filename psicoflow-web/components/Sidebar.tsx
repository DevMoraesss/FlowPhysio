        ...
        <aside className="fixed left-0 top-0 z-40 h-screen w-64 border-r border-sage-200 bg-white dark:bg-zinc-950 dark:border-zinc-900 transition-all duration-300">
            <div className="flex h-full flex-col px-4 py-6">
                <div className="mb-10 flex items-center px-2">
                    ...
                    <span className="text-xl font-bold tracking-tight text-sage-700 dark:text-white">PsicoFlow</span>
                </div>
                ...
                <div className="mt-auto border-t border-sage-100 dark:border-zinc-900 pt-6">
                    <div className="mb-6 flex items-center px-2">
                        ...
                        <div className="ml-3 overflow-hidden">
                            <p className="truncate text-sm font-semibold text-sage-700 dark:text-white">{user?.name || "Psicólogo"}</p>
                            <p className="truncate text-xs text-sage-500 dark:text-zinc-500 italic">Psicoterapeuta</p>
                        </div>
                    </div>

                    <div className="grid grid-cols-2 gap-2">
                        <button className="flex items-center justify-center rounded-xl p-2.5 text-sage-500 hover:bg-sage-100 hover:text-sage-700 dark:text-zinc-500 dark:hover:bg-zinc-900 dark:hover:text-zinc-300 transition-all">
                            <Settings size={20} />
                        </button>
                        <button
