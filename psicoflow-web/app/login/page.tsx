...
export default function LoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            localStorage.setItem("psicoflow_token", data.accessToken);
            localStorage.setItem("psicoflow_user", JSON.stringify(data.user));
        ...
        <div className="flex min-h-screen items-center justify-center bg-zinc-950 p-4">
            <div className="w-full max-w-md space-y-8 rounded-2xl border border-zinc-800 bg-zinc-900/50 p-8 backdrop-blur-xl">
                <div className="flex flex-col items-center text-center">
                    ...
                    <h2 className="mt-6 text-3xl font-bold tracking-tight text-white">PsicoFlow</h2>
                    <p className="mt-2 text-sm text-zinc-400">Entre na sua conta para gerenciar seus pacientes</p>
                </div>
