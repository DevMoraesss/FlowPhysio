...
import { Search, Plus, Filter, MoreHorizontal, Calendar, Phone, Mail, User as UserIcon } from "lucide-react";
    ...
    useEffect(() => {
        async function loadPatients() {
            try {
                ...
                setPatients([
                    { id: "1", name: "Maria Santos", email: "maria@example.com", phone: "(11) 99999-0001", birthDate: "1985-06-12", isMinor: false },
                    { id: "2", name: "João Pedro (Menor)", email: "mae.joao@example.com", phone: "(11) 99999-0002", birthDate: "2015-02-20", isMinor: true, responsible: "Carla Souza" },
                    { id: "3", name: "Ana Beatriz", email: "ana@example.com", phone: "(11) 99999-0003", birthDate: "1992-11-30", isMinor: false },
                ]);
            } finally {
                setLoading(false);
            }
        ...
        <div className="group relative overflow-hidden rounded-[2.5rem] border border-sage-200 bg-white p-6 transition-all hover:border-brand-primary/40 hover:shadow-xl wellness-shadow dark:border-zinc-900 dark:bg-zinc-900/40">
            <div className="flex items-start justify-between">
                <div className="flex items-center">
                    ...
                    <div className="ml-4">
                        <h4 className="text-lg font-bold text-sage-800 dark:text-white leading-tight">{patient.name || "Paciente sem nome"}</h4>
            ...
            <div className="mt-8 space-y-4">
                ...
                {patient.responsibleName && (
                    <div className="flex items-center text-sm text-emerald-600 dark:text-emerald-500">
                        ...
                        <span className="truncate font-medium">Resp: {patient.responsibleName}</span>
                    </div>
                )}
            </div>
